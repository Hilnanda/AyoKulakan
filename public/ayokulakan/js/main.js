...
(function($) {
    ...
    var dropdownAble = $('.custom-dropdown').find('.custom-dropdownable');
    
    $.each(dropdownAble, function(i, el){
        var link = $(this).children('a')
        var ull = $(this).children('ul')

        link.on('click', function(){
            ull.toggleClass('active')
            link.toggleClass('active')
        })
    })

    $('.admin-menu-title').on('click', function(){
  ...
  /* ----------------------------------------------
    ...
    $('#mobile-menu-active-admins').meanmenu({
        meanScreenWidth: "991",
        meanMenuContainer: ".mobile-menu-area-admins .mobile-menu-admins",
    });
